    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" {{ url('/') }} " target="_blank">
                ...
                <span class="ms-1 font-weight-bold">BillBot</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                    ...
                    <a class="nav-link  " href="{{ url('/customers') }}">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M2 20c0-3.314 2.686-6 6-6h2c3.314 0 6 2.686 6 6v2H2v-2z" />
                                <circle cx="17" cy="9" r="3" />
                                <path d="M13 20c0-2.209 1.791-4 4-4h1c2.209 0 4 1.791 4 4v2h-9v-2z" />
                            </svg>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#pagesExamples" class="nav-link active collapsed" aria-controls="pagesExamples" role="button" aria-expanded="false">
                        ...
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="../../pages/pages/rtl-page.html">
                                    <span class="sidenav-mini-icon"> T&C </span>
                                    <span class="sidenav-normal"> Terms & Condition </span>
                                </a>
                            </li>
